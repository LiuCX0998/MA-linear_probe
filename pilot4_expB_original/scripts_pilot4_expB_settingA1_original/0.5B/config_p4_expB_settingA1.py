...
# ============================================================
# Step 5: hidden-state extraction for Step4 implicit-transitive(lr) probes
# Qwen2.5-0.5B version
# ============================================================

STEP5_MODEL_NAME = "Qwen/Qwen2.5-0.5B"
STEP5_MODEL_TAG = "Qwen2_5_0_5B"

# Paragraphs are not very long, but 768 is safe for current Step4T samples.
STEP5_MAX_LENGTH = 768

# Step5 input comes from Step4 implicit-transitive(lr) probe samples.
STEP5_SOURCE_TYPE = "pilot4_step4T_implicit_transitive_probe_samples"
...
# Step5 reads Step4 implicit-transitive(lr) probe sample files.
STEP5_INPUT_DIR = os.path.join(
    DATA_DIR,
    "step4T_implicit_transitive_probe_samples"
)
...
# Step5 output hidden-state features for ExpB SettingA1, Qwen2.5-0.5B.
STEP5_OUTPUT_DIR = os.path.join(
    DATA_DIR,
    "p4_expB_settingA1_step5_hidden_states_qwen2_5_0_5b"
)


# ============================================================
# Step 6: ExpB SettingA1 implicit-transitive linear probing
# ============================================================

STEP6_EXPERIMENT_NAME = "expB_settingA1_implicit_transitive_scene_split_lr_probe"

# Step6 reads Step5 hidden-state .pt files.
# In the Step6 notebook, this directory is populated by unzipping
# the Step5 hidden-state zip.
STEP6_INPUT_DIR = os.path.join(DATA_DIR, "step6_expB_settingA1_input_hidden_states")

STEP6_OUTPUT_DIR = os.path.join(
    DATA_DIR,
    "step6_expB_settingA1_implicit_transitive_outputs",
)
...
# Main label:
#   relation = probe_pair["probe_relation_label"]
#   classes: left_of / right_of
...
# No direct/inverse filtering for this experiment.
STEP6_DIRECTION_FILTER_PROTOCOL = "implicit_transitive"
STEP6_FILTER_TRAIN_BY_DIRECTION = False
STEP6_FILTER_TEST_BY_DIRECTION = False
...
STEP6_GROUP_BY_IMPLICIT_RULE = True
